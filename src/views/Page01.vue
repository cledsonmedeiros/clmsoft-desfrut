    ...
    <v-layout row wrap>
      ...
      <v-flex xs12 sm6>
        <v-card color="white" light :min-height="this.AlturaCardAcaiCremesTigela">
          ...
          <v-data-table :headers="cabecalhoAcaiCopo" :items="tabelaAcaiCopo" hide-default-footer :items-per-page="tabelaAcaiCopo.length"></v-data-table>
